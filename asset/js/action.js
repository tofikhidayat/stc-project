...
$("#limited").click(function(event) {

		$(".times").attr('disabled',false);
});
$("#not-limited").click(function(event) {

		$(".times").attr('disabled',true);
		$(".times").removeClass('border-red');
});



//this for landing page 2



$("#single-action").click(function(event) {

$(".selection-data > input").attr('type', 'radio');
$(".selection-data > input").prop('checked', false);
$(".selection-data-radio > input").prop('checked', false);
$(".selection-data").addClass('selection-data-radio').removeClass('selection-data')


});


$("#multiple-action").click(function(event) {
$(".selection-data-radio > input").attr('type', 'checkbox');
$(".selection-data > input").prop('checked', false);
$(".selection-data-radio > input").prop('checked', false);
$(".selection-data-radio").addClass('selection-data').removeClass('selection-data-radio');
});
});


//tjis for action insert survey
...
//this for submit function only


$(document).ready(function() {
	$("#submit-to-survey").click(function(event) {
	
		window.location ="insert-survey.html";
	...
	$("#publish-u").click(function(event) {

		window.location="survey.action.html";
	});
...
$("#publish-to").click(function(event) {
	window.location = ("survey.action-republish.html");
});
